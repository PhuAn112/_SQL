...
ALTER TABLE Orders ADD COLUMN FormattedOrderDate VARCHAR(10);

UPDATE Orders 
SET FormattedOrderDate = TO_CHAR(OrderDate, 'DD/MM/YYYY');
ALTER TABLE Orders DROP COLUMN OrderDate;
ALTER TABLE Orders RENAME COLUMN FormattedOrderDate TO OrderDate;
